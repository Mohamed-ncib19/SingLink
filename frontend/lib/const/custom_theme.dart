...
ThemeData createThemeData(MaterialColor color, bool isDark, double fontSize) {
  if (isDark) {
    return ThemeData(
      ...
      textTheme: TextTheme(bodyLarge: TextStyle(fontSize: fontSize), bodyMedium: TextStyle(fontSize: fontSize), labelLarge: TextStyle(fontSize: fontSize),
                           headlineLarge: TextStyle(fontSize: fontSize), headlineMedium: TextStyle(fontSize: fontSize), headlineSmall: TextStyle(fontSize: fontSize),)
    );
  } else {
    return ThemeData(
      primarySwatch: color,
